...
import { Gamepad2, Mail, ArrowRight, Code2, X, Menu } from 'lucide-react';
      ...
      <main className="container mx-auto px-6 pt-[60px] lg:px-32 relative z-10">
        ...
        <section id="presence" className="py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            >
              <div className="absolute top-0 right-0 p-6 text-white/5 group-hover:text-[#1db954]/15 transition-colors pointer-events-none">
                <svg role="img" viewBox="0 0 24 24" width="64" height="64" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
